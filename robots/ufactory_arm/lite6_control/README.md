...
```bash
cd lite6_control
wstool merge -t ~/catkin_ws/src/ install/lite6_control.noetic.rosinstall 
wstool update
...
rosrun lite6_control test_manip_lite6.py  # sample motion by command
```
...
rosrun lite6_control test_manip_lite6.py
```

## Gripper motion
```
rosrun lite6_control test_gripper_lite6.py
```
