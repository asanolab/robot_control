...
from dobot_magician_interface.dobot_magician_interface import DobotMagicianInterface


def main():
    rospy.init_node("test_manip_dobot_magician", anonymous=True)
    ri = DobotMagicianInterface("arm")
